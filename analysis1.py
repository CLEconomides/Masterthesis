...
# print(rand)
# seed_dict = {'seed'+ str(i): seedie for i,seedie in random_seeds}
# df_seeds = pd.DataFrame(seed_dict)
# df_seeds.to_csv(r'./results1/seeds.csv')
...
for rep in range(repetitions):
    filepath = r'./results1/rep' + str(rep) + '.csv'
    ...
    for it in range(iterations):
        ...
        print(qml.draw(my_serial_quantum_model)(params))
